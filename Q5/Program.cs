...
namespace Q5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Total money from all cash registers: {CashRegister.overallTotal}");
            Console.WriteLine($"Total items from all cash registers: {CashRegister.overallItemCount}");
        }
    }
}